...
echo '<a href="https://www.google.com/calendar/render?cid=webcal://' .$libGlobal->getSiteUrlAuthority(). '/api.php?iid=semesterprogramm_icalendar" class="btn btn-default"><i class="fa fa-calendar" aria-hidden="true"></i> Programm mit Google Calendar abonnieren</a>';
echo '  ';
echo '<a href="webcal://' .$libGlobal->getSiteUrlAuthority(). '/api.php?iid=semesterprogramm_icalendar" class="btn btn-default"><i class="fa fa-calendar" aria-hidden="true"></i> Programm mit anderer App abonnieren</a>';
echo '</div>';
echo '</div>';
echo '</div>';
echo '</div>';
